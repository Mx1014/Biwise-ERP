...
function isValidEmailAddress(emailAddress) {
    ...
    if ($(window).width() < 570) {
        $('#cpy_url').removeClass('ml-2');
        $('.report_amount').removeClass('mt-5');
        $('.report_amount').removeClass('ml-2');
        $('.report_amount').addClass('ml-4');
    } else {
        $('#cpy_url').addClass('ml-2');
        $('.report_amount').addClass('mt-5');
        $('.report_amount').removeClass('ml-4');
        $('.report_amount').addClass('ml-2');
    }
